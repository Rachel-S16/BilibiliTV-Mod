...
.method public constructor <init>(Lj$/util/stream/a4;Lj$/util/Spliterator;)V
    ...
    .line 1188
    iget-object p2, p1, Lj$/util/stream/a4;->j:Lj$/util/stream/b;

    iput-object p2, p0, Lj$/util/stream/a4;->j:Lj$/util/stream/b;

    .line 1189
    iget-object p2, p1, Lj$/util/stream/a4;->k:Ljava/util/function/IntFunction;

    iput-object p2, p0, Lj$/util/stream/a4;->k:Ljava/util/function/IntFunction;

    .line 1190
    iget-boolean p1, p1, Lj$/util/stream/a4;->l:Z

    iput-boolean p1, p0, Lj$/util/stream/a4;->l:Z
...
.method public constructor <init>(Lj$/util/stream/b;Lj$/util/stream/y1;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)V
    ...
    .line 1180
    invoke-direct {p0, p2, p3}, Lj$/util/stream/c;-><init>(Lj$/util/stream/y1;Lj$/util/Spliterator;)V

    .line 1181
    iput-object p1, p0, Lj$/util/stream/a4;->j:Lj$/util/stream/b;

    .line 1182
    iput-object p4, p0, Lj$/util/stream/a4;->k:Ljava/util/function/IntFunction;
...
.method public final a()Ljava/lang/Object;
    ...
    .line 1205
    iget-object v0, p0, Lj$/util/stream/e;->a:Lj$/util/stream/y1;

    const-wide/16 v1, -0x1

    iget-object v3, p0, Lj$/util/stream/a4;->k:Ljava/util/function/IntFunction;

    invoke-virtual {v0, v1, v2, v3}, Lj$/util/stream/y1;->A0(JLjava/util/function/IntFunction;)Lj$/util/stream/B0;

    move-result-object v0

    .line 1206
    iget-object v1, p0, Lj$/util/stream/a4;->j:Lj$/util/stream/b;
    ...
    .line 1206
    invoke-virtual {v1, v2, v0}, Lj$/util/stream/b;->P0(ILj$/util/stream/p2;)Lj$/util/stream/p2;
    ...
    invoke-virtual {v2, v1}, Lj$/util/stream/y1;->F0(Lj$/util/stream/p2;)Lj$/util/stream/p2;

    move-result-object v1

    iget-object v3, p0, Lj$/util/stream/e;->b:Lj$/util/Spliterator;

    invoke-virtual {v2, v3, v1}, Lj$/util/stream/y1;->h0(Lj$/util/Spliterator;Lj$/util/stream/p2;)Z

    move-result v1

    iput-boolean v1, p0, Lj$/util/stream/a4;->n:Z
    ...
    .line 1214
    :cond_0
    invoke-interface {v0}, Lj$/util/stream/B0;->build()Lj$/util/stream/J0;
    ...
    iput-wide v1, p0, Lj$/util/stream/a4;->m:J
...
.method public final f()V
    ...
    .line 1267
    iget-boolean v0, p0, Lj$/util/stream/a4;->l:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lj$/util/stream/a4;->o:Z

    if-eqz v0, :cond_0

    .line 1200
    iget-object v0, p0, Lj$/util/stream/a4;->j:Lj$/util/stream/b;

    invoke-virtual {v0}, Lj$/util/stream/b;->L0()Lj$/util/stream/d3;

    move-result-object v0

    invoke-static {v0}, Lj$/util/stream/y1;->j0(Lj$/util/stream/d3;)Lj$/util/stream/c1;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    iget-boolean v0, v0, Lj$/util/stream/a4;->n:Z

    iget-object v1, p0, Lj$/util/stream/e;->e:Lj$/util/stream/e;

    check-cast v1, Lj$/util/stream/a4;

    iget-boolean v1, v1, Lj$/util/stream/a4;->n:Z

    or-int/2addr v0, v1

    iput-boolean v0, p0, Lj$/util/stream/a4;->n:Z
    ...
    iget-boolean v3, v0, Lj$/util/stream/a4;->n:Z

    if-eqz v3, :cond_2

    .line 1231
    iget-wide v1, v0, Lj$/util/stream/a4;->m:J
    ...
    iget-wide v3, v0, Lj$/util/stream/a4;->m:J

    iget-object v5, p0, Lj$/util/stream/e;->e:Lj$/util/stream/e;

    check-cast v5, Lj$/util/stream/a4;

    iget-wide v6, v5, Lj$/util/stream/a4;->m:J

    add-long/2addr v3, v6

    iput-wide v3, p0, Lj$/util/stream/a4;->m:J
    ...
    .line 1252
    :cond_3
    iget-wide v3, v5, Lj$/util/stream/a4;->m:J
    ...
    .line 1242
    iput-boolean v0, p0, Lj$/util/stream/a4;->o:Z
