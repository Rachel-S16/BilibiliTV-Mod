...
.method public constructor <init>(Lj$/util/stream/b;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/c3;->a(II)I
...
# virtual methods
.method public final E0(Lj$/util/Spliterator;Lj$/util/stream/p2;)Lj$/util/stream/p2;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lj$/util/stream/b;->F0(Lj$/util/stream/p2;)Lj$/util/stream/p2;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lj$/util/stream/b;->g0(Lj$/util/Spliterator;Lj$/util/stream/p2;)V

    return-object p2
.end method

.method public final F0(Lj$/util/stream/p2;)Lj$/util/stream/p2;
    .locals 2
    ...
    invoke-virtual {v0, v1, p1}, Lj$/util/stream/b;->P0(ILj$/util/stream/p2;)Lj$/util/stream/p2;
...
.method public final H0(Lj$/util/stream/I3;)Ljava/lang/Object;
    .locals 1
    ...
    .line 233
    invoke-interface {p1}, Lj$/util/stream/I3;->w()I
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/I3;->j(Lj$/util/stream/y1;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/I3;->f(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method public final I0(Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
    .locals 3
    ...
    invoke-virtual {p0, v0, v1, p1}, Lj$/util/stream/b;->M0(Lj$/util/stream/y1;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
    ...
    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/b;->k0(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
...
.method public abstract J0(Lj$/util/stream/b;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
.end method

.method public abstract K0(Lj$/util/Spliterator;Lj$/util/stream/p2;)Z
.end method

.method public abstract L0()Lj$/util/stream/d3;
.end method

.method public M0(Lj$/util/stream/y1;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
    .locals 0
...
.method public N0(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    .line 710
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/b;->M0(Lj$/util/stream/y1;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/J0;
...
.method public abstract P0(ILj$/util/stream/p2;)Lj$/util/stream/p2;
.end method
...
.method public final Q0(I)Lj$/util/Spliterator;
    ...
    .line 425
    sget-object v3, Lj$/util/stream/c3;->SHORT_CIRCUIT:Lj$/util/stream/c3;

    invoke-virtual {v3, v4}, Lj$/util/stream/c3;->d(I)Z
    ...
    .line 439
    sget v3, Lj$/util/stream/c3;->t:I

    not-int v3, v3

    and-int/2addr v3, v4

    sget v4, Lj$/util/stream/c3;->s:I
    ...
    .line 440
    :cond_1
    sget v3, Lj$/util/stream/c3;->s:I

    not-int v3, v3

    and-int/2addr v3, v4

    sget v4, Lj$/util/stream/c3;->t:I
    ...
    invoke-static {v4, v0}, Lj$/util/stream/c3;->a(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/c3;->a(II)I
...
.method public final g0(Lj$/util/Spliterator;Lj$/util/stream/p2;)V
    .locals 2
    ...
    invoke-interface {p2, v0, v1}, Lj$/util/stream/p2;->c(J)V

    .line 484
    invoke-interface {p1, p2}, Lj$/util/Spliterator;->forEachRemaining(Ljava/util/function/Consumer;)V

    .line 485
    invoke-interface {p2}, Lj$/util/stream/p2;->m()V

    return-void

    .line 488
    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->h0(Lj$/util/Spliterator;Lj$/util/stream/p2;)Z

    return-void
.end method

.method public final h0(Lj$/util/Spliterator;Lj$/util/stream/p2;)Z
    .locals 3
    ...
    invoke-interface {p2, v1, v2}, Lj$/util/stream/p2;->c(J)V

    .line 502
    invoke-virtual {v0, p1, p2}, Lj$/util/stream/b;->K0(Lj$/util/Spliterator;Lj$/util/stream/p2;)Z
...
.method public final k0(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
    .locals 2
    ...
    .line 545
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/b;->J0(Lj$/util/stream/b;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/J0;
    ...
    .line 548
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/y1;->A0(JLjava/util/function/IntFunction;)Lj$/util/stream/B0;

    move-result-object p2

    .line 550
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->E0(Lj$/util/Spliterator;Lj$/util/stream/p2;)Lj$/util/stream/p2;

    invoke-interface {p2}, Lj$/util/stream/B0;->build()Lj$/util/stream/J0;
