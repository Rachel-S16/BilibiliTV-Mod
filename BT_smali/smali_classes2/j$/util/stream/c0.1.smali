...
.method public static synthetic f(Ljava/util/stream/IntStream;)Lj$/util/stream/e0;
    .locals 1
...
.method public final synthetic a()Lj$/util/stream/e0;
    ...
    invoke-static {v0}, Lj$/util/stream/c0;->f(Ljava/util/stream/IntStream;)Lj$/util/stream/e0;
...
.method public final synthetic asLongStream()Lj$/util/stream/p0;
    ...
    invoke-static {v0}, Lj$/util/stream/n0;->f(Ljava/util/stream/LongStream;)Lj$/util/stream/p0;
...
.method public final synthetic average()Lj$/util/z;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->q(Ljava/util/OptionalDouble;)Lj$/util/z;
...
.method public final synthetic boxed()Lj$/util/stream/Stream;
    ...
    invoke-static {v0}, Lj$/util/stream/a3;->f(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic findAny()Lj$/util/A;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->r(Ljava/util/OptionalInt;)Lj$/util/A;
...
.method public final synthetic iterator()Lj$/util/J;
    .locals 2
    ...
    iget-object v0, v0, Lj$/util/I;->a:Lj$/util/J;
    ...
    invoke-direct {v1, v0}, Lj$/util/H;-><init>(Ljava/util/PrimitiveIterator$OfInt;)V
...
.method public final synthetic l()Lj$/util/stream/p0;
    .locals 2
...
.method public final synthetic limit(J)Lj$/util/stream/e0;
    ...
    invoke-static {p1}, Lj$/util/stream/c0;->f(Ljava/util/stream/IntStream;)Lj$/util/stream/e0;
...
.method public final synthetic mapToObj(Ljava/util/function/IntFunction;)Lj$/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/util/stream/a3;->f(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic onClose(Ljava/lang/Runnable;)Lj$/util/stream/h;
    ...
    invoke-static {p1}, Lj$/util/stream/f;->f(Ljava/util/stream/BaseStream;)Lj$/util/stream/h;
...
.method public final synthetic parallel()Lj$/util/stream/h;
    ...
    invoke-static {v0}, Lj$/util/stream/f;->f(Ljava/util/stream/BaseStream;)Lj$/util/stream/h;
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Lj$/util/A;
    .locals 1
    ...
    invoke-static {p1}, Lj$/com/android/tools/r8/a;->r(Ljava/util/OptionalInt;)Lj$/util/A;
...
.method public final synthetic spliterator()Lj$/util/Spliterator;
    ...
    invoke-static {v0}, Lj$/util/d0;->a(Ljava/util/Spliterator;)Lj$/util/Spliterator;
...
.method public final synthetic spliterator()Lj$/util/W;
    ...
    invoke-static {v0}, Lj$/util/U;->a(Ljava/util/Spliterator$OfInt;)Lj$/util/W;
