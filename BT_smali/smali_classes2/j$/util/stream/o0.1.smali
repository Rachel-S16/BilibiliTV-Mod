...
.method public static synthetic f(Lj$/util/stream/p0;)Ljava/util/stream/LongStream;
    .locals 1
...
.method public final synthetic allMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {p1}, Lj$/util/stream/p0;->x()Z
...
.method public final synthetic asDoubleStream()Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/p0;->asDoubleStream()Lj$/util/stream/C;
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/p0;->average()Lj$/util/z;
...
.method public final synthetic findAny()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/p0;->findAny()Lj$/util/B;

    move-result-object v0

    invoke-static {v0}, Lj$/com/android/tools/r8/a;->w(Lj$/util/B;)Ljava/util/OptionalLong;
...
.method public final synthetic findFirst()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/p0;->findFirst()Lj$/util/B;
...
.method public final flatMap(Ljava/util/function/LongFunction;)Ljava/util/stream/LongStream;
    ...
    .line 0
    invoke-interface {v0, v1}, Lj$/util/stream/p0;->d(Lj$/util/n;)Lj$/util/stream/p0;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/p0;->iterator()Lj$/util/N;
    ...
    invoke-direct {v1, v0}, Lj$/util/M;-><init>(Lj$/util/N;)V
...
.method public final synthetic mapToDouble(Ljava/util/function/LongToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/p0;->k()Lj$/util/stream/C;
...
.method public final synthetic mapToInt(Ljava/util/function/LongToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/p0;->B()Lj$/util/stream/e0;
...
.method public final synthetic max()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/p0;->max()Lj$/util/B;
...
.method public final synthetic min()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/p0;->min()Lj$/util/B;
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Ljava/util/OptionalLong;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/p0;->reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/B;

    move-result-object p1

    invoke-static {p1}, Lj$/com/android/tools/r8/a;->w(Lj$/util/B;)Ljava/util/OptionalLong;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/p0;->spliterator()Lj$/util/Z;
...
.method public final summaryStatistics()Ljava/util/LongSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/p0;->summaryStatistics()Lj$/util/x;
